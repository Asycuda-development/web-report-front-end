            ...
            <SimpleCard title="DPS_4551">
                ...
                <Box width="100%" overflow="auto">
                    ...
                    >
                        ...
                        <Column filter filterField="typeOfPackage" field={'typeOfPackage'} header={'Type Of Package'} />
                        ...
                        <Column filter filterField="itemGrossWeight" field={'itemGrossWeight'} header={'Item Gross Weight'} />
                        ...
                        <Column filter filterField="companyTin" style={{ minWidth: '12rem' }} field={'companyTin'} header={'Company Tin'} />
                        ...
                        <Column filter filterField="countryExport" field={'countryExport'} header={'Country Export'} />
                        ...
                        <Column filter filterField="tarVmtSecond" field={'tarVmtSecond'} header={'Tar VTM Second'} />
                        <Column filter filterField="gCategoryOfGoods1" field={'gCategoryOfGoods1'} header={'G Category Of Goods1'} />
