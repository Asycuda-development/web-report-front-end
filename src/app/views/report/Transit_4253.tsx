...
const Transit_4253 = () => {
  ...
  return (
    <SimpleCard title="Transit Report 4253">
      <ReportHeaderInputs
        showStartDate
        showEndDate
        showAssesDate
      ...
      <Box width="100%" overflow="auto">
        ...
        >
          ...
          <Column field={'max_Date_Of_Arrival_Limit'} header={'max_Date_Of_Arriv />al_Limit'} />
          ...
          <Column field={'gross_Mass'} header={'Tross_Mass'} />
          ...
          <Column field={'Nationality_Of_Transport'} header={'Nationality_Of_Tra />nsport'} />
