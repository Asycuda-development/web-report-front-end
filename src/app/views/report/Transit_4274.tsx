...
const Transit_4274 = () => {
  ...
  return (
    <SimpleCard title="Transit Report 4274">
      <ReportHeaderInputs
        showStartDate
        showEndDate
        showI_Number
      ...
      <Box width="100%" overflow="auto">
        ...
        >
          ...
          <Column field={'val_No;'} header={'Validation_No;'} />
          ...
          <Column field={'assest_officer'} header={'Assessment Officers'} />
          ...
          <Column field={'exp_Code'} header={'Ctry_Of_Export_code'} />
          ...
          <Column field={'at2_Nbr'} header={'at2_NATT_AT2_nbrbr'} />
