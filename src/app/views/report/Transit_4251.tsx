    ...
    <SimpleCard title="4251- Transit">
      ...
      <Box width="100%" overflow="auto">
        ...
        >
          ...
          <Column field={'dec_Ref'} header={'Declaration_Ref_Year'} />
          ...
          <Column field={'val_Date'} header={'Validation Date'} />
          ...
          <Column field={'cns_Code'} header={'Contractor Code'} />
          <Column field={'cns_Name'} header={'Contractor Name'} />
